...
for (part in 1:length(name)) {
  #  if (file.exists(paste0(name[part],'/MD/stabilisation/protein/loop_',df_start$name[i],'.pdb'))) {
  pdb_ionized<-read.pdb(paste0(name[part],'/MD/stabilisation/protein/ionized_',name[part],'.pdb'))
